...
const locationController = {
    ...
    getById: async (req, res) => {
        try {
            ...
            const row = await Location.findOne({ where: whereClause });
    ...
    update: async (req, res) => {
        try {
            ...
            // If the user is trying to MOVE the location to another business, we should allow it if they own the target business
