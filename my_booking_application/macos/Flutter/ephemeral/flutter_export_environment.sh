...
export "FLUTTER_FRAMEWORK_SWIFT_PACKAGE_PATH=C:\Ally_Soft_Solution\Ally_Soft_Solution_Git_Projects\My_Bookings\my_booking_application\macos\Flutter\ephemeral\Packages\.packages\FlutterFramework"
